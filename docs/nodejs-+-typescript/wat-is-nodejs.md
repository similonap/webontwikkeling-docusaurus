...
Vandaag de dag is JavaScript (mede dankzij TypeScript) volgens de _Stack Overflow Developer Survey_ en _GitHub Octoverse_ al jarenlang de **meest gebruikte programmeertaal ter wereld**.
