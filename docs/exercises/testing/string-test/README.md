...
Download het <a href="/exercises/testing/string-test/starter.zip">starter</a> project. Dit project bevat een `string-utils.ts` module. Schrijf de volgende testen:
