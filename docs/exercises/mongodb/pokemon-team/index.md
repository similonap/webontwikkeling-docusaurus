...
Maak een nieuw project aan met de naam `pokemon-team` en installeer de `mongodb` package. Je kan hiervoor starten vanuit het project [pokemon-team](../../node-typescript/pokemon-team/index.md) dat je al eerder hebt gemaakt.
